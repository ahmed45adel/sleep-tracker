...
const ContactPage = () => {
  return (
    <div className="font-sans bg-muted text-foreground">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-16 px-8 bg-muted">
      ...
      <section className="py-16 px-8 bg-background">
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const mailtoLink = `mailto:fakesupport@sleeptracker.com?subject=Message from ${name}&body=Email: ${email}%0D%0A%0D%0A${message}`;
        ...
        >
          <div>
            ...
            <input
              ...
              id="name"
              name="name"
              className="mt-1 block w-full px-4 py-2 border border-border rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500 bg-background text-foreground"
      ...
      <section className="py-16 px-8 bg-muted">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-muted-foreground">fakesupport@sleeptracker.com</p>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-2">Phone</h3>
            <p className="text-muted-foreground">(+20)1011231746</p>
          </div>
          <div>
