...
const AboutPage = () => {
  return (
    <div className="font-sans bg-muted text-foreground">
      ...
      <section className="py-16 px-8 bg-muted text-center">
        ...
        <Link
          href="/sign-up"
          className="inline-block bg-background text-purple-600 hover:text-purple-700 px-6 py-3 rounded-md font-medium shadow-md transition"
        >
          Get Started
        </Link>
      </section>
